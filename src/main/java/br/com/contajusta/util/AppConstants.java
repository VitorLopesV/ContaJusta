...
public class AppConstants {
    ...
    public static final String HOW_WORKS_RUSSIAN_ROULETTE = "Os participantes informam seus nomes e haverá um sorteio para " +
            "para saber quem será o 'Sortudo' que vai pagar a conta.";
